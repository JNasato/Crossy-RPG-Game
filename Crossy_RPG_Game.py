...
class Game:
    ...
    def run_game_loop(self, level_speed):
        ...
        player_character = PlayerCharacter('player.png', 475, 930, 50, 50)
        
        enemy_0 = NonPlayerCharacter('enemy.png', randint(20, 930), 600, 50, 50)
        # Speed increased as we advance in difficulty
        enemy_0.SPEED *= level_speed / 1.25

        # Create another enemy
        enemy_1 = NonPlayerCharacter('enemy.png', randint(20, 930), 400, 50, 50)
        enemy_1.SPEED *= level_speed

        # Create another enemy
        enemy_2 = NonPlayerCharacter('enemy.png', randint(20, 930), 800, 50, 50)
        enemy_2.SPEED *= level_speed / 1.5

        # Create another enemy
        enemy_3 = NonPlayerCharacter('enemy.png', randint(20, 930), 200, 50, 50)
        enemy_3.SPEED *= level_speed * 1.25
        
        treasure = GameObject('treasure.png', 475, 50, 50, 50)
        ...
        while not is_game_over:
            ...
            for event in pygame.event.get():
                ...
                # Detect when key is pressed down
                    ...
                    # Move up if up key pressedPressStart2P-Regular.ttf
            ...
            text = font.render(f"Level {int(level_speed * 2 - 1)}", True, BLACK_COLOR)
            self.game_screen.blit(text, (200, 275))

            if level_speed > 10:
                great_job = font.render("Great Job!", True, BLACK_COLOR)
                keep_going = font.render("Keep Going!", True, BLACK_COLOR)
                self.game_screen.blit(great_job, (600, 275))
                self.game_screen.blit(keep_going, (600, 325))
